                ...
                <q-menu>
                    <q-list style="min-width: 100px">
                            ...
                            >
                                <q-list style="min-width: 100px">
                                    <q-item
                                        ...
                                        :key="playlist.id"
                                        @click="
                                            onAddToPlaylistClicked(playlist.id)
                                        "
                                    >
                                        <q-item-section>{{
                                            playlist.name
                        ...
                        <q-item
                            clickable
                            v-close-popup
                            @click="onCopyUrlClicked(sound.id)"
                        >
                            <q-item-section avatar>
                                <q-icon name="copy" />
                            </q-item-section>
...
export default {
    ...
    methods: {
        ...
        onAddToPlaylistClicked: async function(playlistId) {
            await this.$store.dispatch('library/addBoardSoundToLibrary', {
                sound: this.sound,
                playlistId,
            })
        },
        onCopyUrlClicked: async function(id) {
